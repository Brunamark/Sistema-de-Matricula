...
public class ProfessorRepository {
    ...
    private static final String ARQUIVO_PROFESSORES = "file/professores.txt";
    ...
    public boolean lecionaDisciplina(Long professorId, Long disciplinaId) {
        if (professorId == null || disciplinaId == null) return false;
        
        Professor professor = buscarPorId(professorId);
        if (professor == null || professor.getDisciplina() == null) return false;
    ...
    public boolean atribuirDisciplina(Long professorId, Disciplina disciplina) {
        if (professorId == null || disciplina == null) return false;
    ...
    public boolean substituirDisciplina(Long professorId, Disciplina novaDisciplina) {
        if (professorId == null || novaDisciplina == null) return false;
