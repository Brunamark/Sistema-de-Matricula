...
public class AlunoRepository {
    ...
    public boolean adicionarDisciplina(Long alunoId, Disciplina disciplina) {
        if (alunoId == null || disciplina == null)
            return false;
    ...
    public boolean transferirAluno(Long alunoId, Long novoCursoId) {
        if (alunoId == null || novoCursoId == null)
            return false;
    ...
    public Aluno buscarPorEmailSenha(String email, String senha) {
        ...
        return alunos.stream()
                .filter(a -> a.getEmail() != null && a.getSenha() != null)
                .filter(a -> a.getEmail().equalsIgnoreCase(email) && a.getSenha().equals(senha))
                .findFirst()
                .orElse(null);
    }
